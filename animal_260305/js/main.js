...
$(document).ready(function () {
    ...
    /******************************
     * tab 메뉴 구성
     *  .find .tab_list ul li 를 클릭하면
     * 1. li에 있는 active 클래스를 클릭한 li에만 줘야함
     * 2. 클릭한 li만 aria-selected를 tru로 변경 (나머지는 false)
     * 3. 선택된 li의 button에만 <em>선택됨</em> 이라고 함
     * 4. 선택되 li의 aria-controls에 써있는 속성값을 가져다가
     ...
     * message가 스크롤 되는 동안 p strong span 태그가 넓이가 넓어지면서 색상 바꿈
     * ****************************************/
    ...
    let color_w //넓이
    let color_header //header

    let color_start //색상을 변경하기 시작하는 위치
    let color_end //색상 변경에 종료되는 위치
